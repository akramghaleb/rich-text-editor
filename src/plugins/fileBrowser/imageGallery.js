...
export default {
  ...
  add: function (core) {
    ...
    context.imageGallery = {
      ...
      listClass: "meta-image-list", // @Required @Override fileBrowser - Class name of list div.
      ...
      columnSize: 4, // @Option @Override fileBrowser - Number of "div.meta-file-item-column" to be created (default: 4)
    };
  },
  ...
  /**
   * @Required @Override fileBrowser
   * @description Define the HTML of the item to be put in "div.meta-file-item-column".
   * Format: [
  ...
  drawItems: function (item) {
    ...
    return (
      '<div class="meta-file-item-img"><img src="' +
      item.src +
      '" alt="' +
      (item.alt || srcName) +
      '" data-command="pick">' +
      '<div class="meta-file-img-name meta-file-name-back"></div>' +
      '<div class="meta-file-img-name __meta__img_name">' +
      (item.name || srcName) +
      "</div>" +
      "</div>"
    );
  ...
  setImage: function (target) {
    this.callPlugin(
      ...
      function () {
        const file = {
          name: target.parentNode.querySelector(".__meta__img_name").textContent,
          size: 0,
        };
