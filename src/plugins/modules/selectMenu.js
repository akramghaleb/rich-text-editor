...
export default {
  ...
  setForm: function () {
    return '<div class="meta-select-list"></div>';
  },
  ...
  initEvent: function (pluginName, forms) {
    const form = forms.querySelector(".meta-select-list");
  ...
  onMouseMove_list: function (context, e) {
    this.util.addClass(context.form, "__meta_select-menu-mouse-move");
  ...
  moveItem: function (listContext, num) {
    this.util.removeClass(listContext.form, "__meta_select-menu-mouse-move");
