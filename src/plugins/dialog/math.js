...
export default {
  ...
  add: function (core) {
    ...
    context.math.focusElement = math_dialog.querySelector(".meta-math-exp");
    context.math.previewElement = math_dialog.querySelector(".meta-math-preview");
    context.math.fontSizeElement = math_dialog.querySelector(".meta-math-size");
    context.math.focusElement.addEventListener("keyup", this.renderMathExp.bind(core, context.math), false);
    context.math.focusElement.addEventListener("change", this.renderMathExp.bind(core, context.math), false);
  ...
  setDialog: function (core) {
    ...
    let html =
      ...
      '<textarea class="meta-input-form meta-math-exp" type="text"></textarea>' +
      "</div>" +
      '<div class="meta-dialog-form">' +
      "<label>" +
      lang.dialogBox.mathBox.fontSizeLabel +
      "</label>" +
      '<select class="meta-input-select meta-math-size">';
  ...
  setController_MathButton: function (core) {
    ...
    math_btn.className = "meta-controller meta-controller-link";
    math_btn.innerHTML =
      "" +
      '<div class="meta-arrow meta-arrow-up"></div>' +
      '<div class="link-content">' +
      '<div class="meta-btn-group">' +
      '<button type="button" data-command="update" tabindex="-1" class="meta-btn meta-tooltip">' +
      core.icons.edit +
      ...
      method: function (element) {
        ...
        const dom = this._document
          ...
          .createContextualFragment(
            this.plugins.math.render.call(this, this.util.HTMLDecoder(element.getAttribute("data-exp")))
          );
  ...
  renderMathExp: function (contextMath, e) {
    contextMath.previewElement.innerHTML = this.plugins.math.render.call(this, e.target.value);
  },
  ...
  submit: function (e) {
    ...
    const submitAction = function () {
      ...
      katexEl.className = "__meta__katex " + katexEl.className;
      ...
      if (!this.context.dialog.updateModal) {
        ...
        const containerEl = this.util.getParentElement(contextMath.mathExp, ".katex");
  ...
  on: function (update) {
    if (!update) {
      ...
      if (contextMath.mathExp) {
        const exp = this.util.HTMLDecoder(contextMath.mathExp.getAttribute("data-exp"));
        const fontSize = contextMath.mathExp.getAttribute("data-font-size") || "1em";
        this.context.dialog.updateModal = true;
        contextMath.focusElement.value = exp;
        contextMath.fontSizeElement.value = fontSize;
        contextMath.previewElement.innerHTML = this.plugins.math.render.call(this, exp);
  ...
  onClick_mathController: function (e) {
    ...
    if (/update/.test(command)) {
      this.context.math.focusElement.value = this.util.HTMLDecoder(this.context.math.mathExp.getAttribute("data-exp"));
