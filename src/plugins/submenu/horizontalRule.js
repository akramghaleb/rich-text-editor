...
export default {
  ...
  setSubmenu: function (core) {
    ...
    listDiv.className = "meta-submenu meta-list-layer meta-list-line";
    listDiv.innerHTML =
      "" +
      '<div class="meta-list-inner">' +
      '<ul class="meta-list-basic">' +
      "<li>" +
      '<button type="button" class="meta-btn-list btn_line" data-command="horizontalRule" data-value="solid" title="' +
      ...
      "</li>" +
      "<li>" +
      '<button type="button" class="meta-btn-list btn_line" data-command="horizontalRule" data-value="dotted" title="' +
      ...
      "</li>" +
      "<li>" +
      '<button type="button" class="meta-btn-list btn_line" data-command="horizontalRule" data-value="dashed" title="' +
  ...
  horizontalRulePick: function (e) {
    ...
    const oNode = this.plugins.horizontalRule.appendHr.call(this, "__meta__" + value);
    if (oNode) {
