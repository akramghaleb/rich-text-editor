...
declare interface util {
   ...
   * @param doc To get the CSS text of an document(core._iframeDocument). If null get the current document.
  ...
  /**
   * @description It is judged whether it is the component [img, iframe, video, audio] cover(class="meta-component") and table, hr
   * @param element The node to check
   * @returns
   */
   ...
   * @returns
   */
  getRangeFormatElement(element: Node, validation?: Function): Element | Node | null;
   ...
   * @returns
   */
  getFreeFormatElement(element: Node, validation?: Function): Element | Node | null;
   ...
   * @returns
   */
  getNodePath(node: Node, parentNode?: Node, newOffsets?: { s: number; e: number }): number[];
