...
import type { History } from "./history.d";
import type { Plugin } from "./../plugins/Plugin.d";
import type { Lang } from "./../lang/Lang.d";
import type { ExploreEditorOptions } from "./../options.d";
import type { Context } from "./context.d";
import type Util from "./util.d";
import type { Module } from "../plugins/Module.d";
import type Notice from "../plugins/modules/notice.d";
...
export default class ExploreEditor {
  constructor(
    context: Context,
    pluginCallButtons: Record<string, Element>,
    plugins: Record<string, Plugin>,
   ...
   */
  setOptions(options: ExploreEditorOptions): void;
